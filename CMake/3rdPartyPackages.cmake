...
# Included by Fetch3rdParty.cmake and FetchDependencies.cmake.
# Caller must define Fetch3rdParty_Package(name version url url_hash) before including this file.

Fetch3rdParty_Package(cmakerc 952ff
...
if(NOT VIO_USE_SYSTEM_LIBUV)
    Fetch3rdParty_Package(libuv v1.51.0
...
if(NOT VIO_USE_SYSTEM_DOCTEST)
    Fetch3rdParty_Package(doctest v2.4.11
...
if(NOT VIO_USE_SYSTEM_LIBRESSL)
    Fetch3rdParty_Package(libressl 4.1.0
...
if(NOT VIO_USE_SYSTEM_ADA)
    Fetch3rdParty_Package(ada 3.2.4

...
# Included by CmDepFetch3rdParty and CmDepFetchDependencies.
# Caller must define CmDepFetch3rdParty_Package(name version url url_hash) before including this file.

CmDepFetch3rdParty_Package(cmakerc 952ff
...
if(NOT VIO_USE_SYSTEM_DOCTEST)
    CmDepFetch3rdParty_Package(doctest v2.4.11
...
if(NOT VIO_USE_SYSTEM_LIBRESSL)
    CmDepFetch3rdParty_Package(libressl 4.1.0
...
if(NOT VIO_USE_SYSTEM_ADA)
    CmDepFetch3rdParty_Package(ada 3.2.4

...
if (NOT TARGET LibreSSL::Crypto)
    ...
    set_target_properties(LibreSSL::Crypto
        ...
        CMDEP_TARGET libressl
        CMDEP_INCLUDE_DIRS "${LIBRESSL_INCLUDE_DIRECTORIES}"
        CMDEP_LOCATION_RELEASE "${LIBRESSL_CRYPTO_IMPL_LIB_RELEASE}"
        CMDEP_LOCATION_DEBUG "${LIBRESSL_CRYPTO_IMPL_LIB_RELEASE}"
        IMPORTED_LOCATION_RELEASE "${LIBRESSL_CRYPTO_IMPL_LIB_RELEASE}"
        IMPORTED_LOCATION_DEBUG "${LIBRESSL_CRYPTO_IMPL_LIB_RELEASE}"
...
if (NOT TARGET LibreSSL::SSL)
    ...
    set_target_properties(LibreSSL::SSL
        ...
        CMDEP_TARGET libressl
        CMDEP_INCLUDE_DIRS "${LIBRESSL_INCLUDE_DIRECTORIES}"
        CMDEP_LOCATION_RELEASE "${LIBRESSL_SSL_IMPL_LIB_RELEASE}"
        CMDEP_LOCATION_DEBUG "${LIBRESSL_SSL_IMPL_LIB_RELEASE}"
        IMPORTED_LOCATION_RELEASE "${LIBRESSL_SSL_IMPL_LIB_RELEASE}"
        IMPORTED_LOCATION_DEBUG "${LIBRESSL_SSL_IMPL_LIB_RELEASE}"
        MAP_IMPORTED_CONFIG_MINSIZEREL Release
        MAP_IMPORTED_CONFIG_RELWITHDEBINFO Release
        IMPORTED_LINK_INTERFACE_LANGUAGES "C"
    )
...
if (NOT TARGET LibreSSL::TLS)
    ...
    set_target_properties(LibreSSL::TLS
        ...
        CMDEP_TARGET libressl
        CMDEP_INCLUDE_DIRS "${LIBRESSL_INCLUDE_DIRECTORIES}"
        CMDEP_LOCATION_RELEASE "${LIBRESSL_TLS_IMPL_LIB_RELEASE}"
        CMDEP_LOCATION_DEBUG "${LIBRESSL_TLS_IMPL_LIB_RELEASE}"
        IMPORTED_LOCATION_RELEASE "${LIBRESSL_TLS_IMPL_LIB_RELEASE}"
        IMPORTED_LOCATION_DEBUG "${LIBRESSL_TLS_IMPL_LIB_RELEASE}"
        MAP_IMPORTED_CONFIG_MINSIZEREL Release
        MAP_IMPORTED_CONFIG_RELWITHDEBINFO Release
        IMPORTED_LINK_INTERFACE_LANGUAGES "C"
    )

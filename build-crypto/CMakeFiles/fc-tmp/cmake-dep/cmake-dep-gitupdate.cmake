...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "71abe2b188d28f433bf6436bcf5e5b0edc49b6ce"
  WORKING_DIRECTORY "/home/jlind/dev/vio/3rdparty/cmake-dep-71abe2b188d28f433bf6436bcf5e5b0edc49b6ce"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "71abe2b188d28f433bf6436bcf5e5b0edc49b6ce")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("71abe2b188d28f433bf6436bcf5e5b0edc49b6ce" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 71abe2b188d28f433bf6436bcf5e5b0edc49b6ce")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/71abe2b188d28f433bf6436bcf5e5b0edc49b6ce")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"71abe2b188d28f433bf6436bcf5e5b0edc49b6ce\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/jlind/dev/vio/3rdparty/cmake-dep-71abe2b188d28f433bf6436bcf5e5b0edc49b6ce'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jlind/dev/vio/3rdparty/cmake-dep-71abe2b188d28f433bf6436bcf5e5b0edc49b6ce'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

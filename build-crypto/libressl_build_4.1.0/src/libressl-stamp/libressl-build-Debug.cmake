...
set(command "/usr/bin/cmake;--build;.;--config;Debug")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/home/jlind/dev/vio/build-crypto/libressl_build_4.1.0/src/libressl-stamp/libressl-build-out.log")
set(stderr_log "/home/jlind/dev/vio/build-crypto/libressl_build_4.1.0/src/libressl-stamp/libressl-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/jlind/dev/vio/build-crypto/libressl_build_4.1.0/src/libressl-stamp/libressl-build-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "libressl build command succeeded.  See also /home/jlind/dev/vio/build-crypto/libressl_build_4.1.0/src/libressl-stamp/libressl-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()

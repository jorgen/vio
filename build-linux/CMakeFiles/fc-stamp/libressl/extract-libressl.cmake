...
#
get_filename_component(filename "/home/jlind/dev/vio/build-linux/_deps/libressl-tmp/libressl-4.3.2.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/jlind/dev/vio/3rdparty/libressl-4.3.2" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libressl${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libressl${i}")

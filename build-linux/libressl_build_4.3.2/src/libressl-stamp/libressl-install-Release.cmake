...
set(stdout_log "/home/jlind/dev/vio/build-linux/libressl_build_4.3.2/src/libressl-stamp/libressl-install-out.log")
set(stderr_log "/home/jlind/dev/vio/build-linux/libressl_build_4.3.2/src/libressl-stamp/libressl-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/jlind/dev/vio/build-linux/libressl_build_4.3.2/src/libressl-stamp/libressl-install-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "libressl install command succeeded.  See also /home/jlind/dev/vio/build-linux/libressl_build_4.3.2/src/libressl-stamp/libressl-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
